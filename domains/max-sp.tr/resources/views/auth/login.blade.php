        ...
        <div class="container">
            <div class="login-block">
                ...
                <form method="POST" action="{{ route('login') }}" class="form">
                    ...
                    <div class="form-row">
                        <input type="password" id="password" name="password" class="@error('password') is-invalid @enderror" placeholder="Пароль" required="" autocomplete="current-password"/>
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}">
                        <button class="btn" style="margin-top: 20px;">Забыли пароль?</button>
                    </a>
                @endif
            </div>
        </div>
