...
@section('content')
    <div class="main main_inner" style="background-image: url(img/projects-page-bg.jpg);">
        <div class="container">
            <h1>Наши проекты</h1>
        </div>
    </div>
    <div class="main-facts">
        <div class="container">
            <div class="main-facts-block flex-box flex-center">
                ...
                <div class="main-facts-item">
                    ...
                    <div class="main-facts-item-bottom">труб тёплого<br> пола уложено</div>
                </div>
                <div class="main-facts-item">
                    <div class="main-facts-item-top"><span>600</span></div>
                    <div class="main-facts-item-bottom">электрических<br> котлов смонтировано</div>
                </div>
                <div class="main-facts-item">
                    <div class="main-facts-item-top"><span>20+</span></div>
                    <div class="main-facts-item-bottom">твердотопливных<br> котлов установлено</div>
                </div>
            </div>
        </div>
    </div>
    <div class="projects-about">
        <div class="container">
            <div class="padleft-200">
                <div class="projects-about-block">
                    <p>Мы выполнили работы на 500 объектах малоэтажного строительства,
                        а так же многоэтажного строительства, школ, детских садов, физкультурно-оздоровительных
                        комплексов.</p>
                    <p>Уложили 500 000 километров труб теплого пола. Смонтировали около 600 электрических котлов разных
                        мощностей и производителей. Установили
                        не один десяток твердотопливных котлов.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="works_innerpage works wow fadeIn">
        <div class="container">
            <div class="padleft-200">
                ...
                <!--                <a href="" class="border-link">Ещё проекты</a>-->
                <!--            </div>-->
            </div>
        </div>
    </div>
