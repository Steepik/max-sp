...
@section('content')
    <div class="text-page-main">
        <div class="container">
            <div class="padleft-200">
                <h1><span class="yellow">Ответы</span> на
                    самые популярные&nbsp;вопросы</h1>
                <p class="sub-title">
                    Мы подготовили для вас ответы на самые популярные вопросы.<br>
                    Если вы получили не все ответы, напишите свой вопрос<br>
                    в форму ниже и мы ответим в ближайшее время.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="faq wow fadeIn">
        <div class="container">
            <div class="padleft-200">
                <div class="faq-item">
                    <div class="faq-item-title">Достаточно ли отапливать жилое помещение только водяным теплым полом?
                    </div>
                    <div class="faq-item-info">Да, в независимости от площади помещения и размера окон.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-item-title">Какое утепление необходимо для под трубами теплого пола?</div>
                    <div class="faq-item-info">В стоимости наших теплых полов уже учтен утеплитель толщиной 50мм, это
                        минимум
                        который необходим для правильной работы теплого пола.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-item-title">Возможно ли изменение стоимости договора в ходе выполнения монтажных
                        работ?</div>
                    <div class="faq-item-info">После расчета и подписания стоимость договора не изменится.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-item-title">Можно ли сделать теплый пол если у меня деревянные перекрытия?</div>
                    <div class="faq-item-info">Да, в стоимость добавятся теплораспределительные пластины и вместо
                        бетонной стяжки
                        необходимо будет покрыть трубу фанерой либо ГВЛ.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-item-title">Какую жидкость вы заливаете в систему отопления?</div>
                    <div class="faq-item-info">Концентрат незамерзающей жидкости на основе этиленгликоля, разбавленный
                        дистиллированной водой до температуры замерзания -40°С.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-item-title">Можете ли вы сделать бетонную стяжку пола?</div>
                    <div class="faq-item-info">Да, это будет полусухая стяжка для частного дома, либо промышленные
                        бетонные полы
                        для производственных помещений.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-item-title">Можно ли сделать водяной теплый пол в квартире многоэтажного здания?
                    </div>
                    <div class="faq-item-info">Нет, запрещено законодательством.</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="order wow fadeIn">
        <div class="container">
            <div class="padleft-200">
                <div class="form-block">
                    <h2>Задать вопрос</h2>
                    <p class="sub-title">Оставьте свой вопрос, а мы постараемся ответить<br> на него в ближайшее время.
                    </p>
                    <form class="form">
                        <input type="hidden" name="theme" value="Задать вопрос">

                        <div class="space-between flex-box mb-50">
                            <div class="form-row">
