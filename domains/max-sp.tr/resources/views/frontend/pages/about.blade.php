...
@section('content')
<div class="main main_inner" style="background-image: url({{ asset('img/about-bg.jpg') }});">
    <div class="container">
        <h1>О компании <br>ВостСибКомпозит</h1>
        <p class="sub-title">Сделаем гидравлический теплый пол<br> в любом помещении с любым основанием.</p>
    </div>
</div>
<div class="history wow fadeIn">
    <div class="container">
        <div class="padleft-160">
            <h2>Работаем <span class="yellow">с 2010 года</span></h2>
            <p>Наша компания занимается проектированием и монтажом гидравлических теплых полов с 2010 года. За
                десять
                лет
                работы мы точно знаем, что предложить своим клиентам. Большой опыт на рынке теплых полов научил нас
                точно
                рассчитывать итоговую стоимость работ и в нашей политике принципиально не поднимается сумма договора
                в
                ходе
                монтажа.</p>
        </div>
    </div>
    <img class="history-img" src="{{ asset('img/history-img.jpg') }}">
</div>
            ...
            <div class="padleft-200">
                <div class="projects-block">
                    ...
                    <div class="projects-content">
                        <p>В списке выполненных работ уже более 500 завершенных объектов малоэтажного строительства,
                            есть
                            опыт
                            работ
                            в многоэтажном строительстве, школ, детских садов, физкультурно-оздоровительных
                            комплексов.</p>
                        <p>Уложено более 500 000 километров труб теплого пола, смонтировано около 600 электрических
                            котлов
                            разных
                            мощностей и производителей, установлен не один десяток твердотопливных котлов.</p>
                        <p>Большой опыт работ на рынке теплых полов позволил нам найти более оптимальное соотношение
                            цены и
                            качества используемых материалов, которые проверены временем.</p>
                        <div class="projects-facts-row">
                            <div class="projects-facts-big">500+</div>
                            <div class="projects-facts-small">завершённых объектов</div>
                        </div>
                        <div class="projects-facts-row">
                            <div class="projects-facts-big">500 <span>тыс. км</span></div>
                            <div class="projects-facts-small">труб тёплого пола уложено</div>
                        </div>
                        <div class="projects-facts-row">
                            <div class="projects-facts-big">600</div>
                            <div class="projects-facts-small">электрических котлов смонтировано</div>
                        </div>
                        <div class="projects-facts-row">
                            <div class="projects-facts-big">20+</div>
                            <div class="projects-facts-small">твердотопливных котлов установлено</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="padleft-200">
            <div class="about-work-block">
                <div class="about-work-block-inner">
                    <h2><span class="yellow">Мы любим</span><br> свою работу</h2>
                    <p>Мы любим свою работу и с большим интересом рассказываем о теплых полах, о плюсах и минусах. А
                        на
                        встече в нашем офисе мы наглядно покажем на стендах что такое теплый пол, что входит в
                        стоимость и
                        почему именно теплый пол, а не другое отопление.</p>
                    <p>Заключение договора с клиентами узаконит нашу работу и официально продлит гарантию на
                        установленное
                        оборудование со дня ввода в эксплуатацию. Мы являемся как раз теми квалифицированными
                        специалистами,
                        о которых пишут в паспорте об условиях гарантии.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="padleft-200">
            <div class="documentation-block">
                <h2>Документация</h2>
                <p>Вместе с работой и паспортами к оборудованию мы передаем техническую документацию от нашей
                    компании,
                    где
                    прописана краткая инструкция по эксплуатации и обслуживанию системы отопления и полную
                    фотосессию
                    всех
                    выполненных работ.</p>
                <p>Вся техническая документация и инструкции по эксплуатации будут находиться в вашем Личном
                    кабинете в
                    течение всего срока эксплуатации теплых полов.</p>
            </div>
        </div>
    </div>
</div>
<div class="clients wow fadeIn">
    <div class="container">
        <div class="padleft-200">
            <h2>Наши <span class="yellow">клиенты</span></h2>
            <p>После завершения работ мы остаемся в дружеских отношениях с нашими клиентами</p>
            <div class="clients-row">
                <div class="clients-item">Отель Флагман</div>
                <div class="clients-item">Ангарский стомотологический центр</div>
                <div class="clients-item">Физкультурно-оздоровительный центр БААТАР</div>
                <div class="clients-item">БТИ</div>
                <div class="clients-item">ИркутскЭнерго</div>
            </div>
            <!--<table class="clients-block">-->
            <!--<tr>-->
            <!--<td>-->
            <!--<span>отель</span>-->
            <!--<span class="big">Флагман</span>-->
            <!--</td>-->
            <!--<td>-->
            <!--<span class="big">Ангарский</span>-->
            <!--<span>стоматологический центр</span>-->
            <!--</td>-->
            <!--<td>-->
            <!--<span class="big">Баатар</span>-->
            <!--<span>ФИЗКУЛЬТУРНО-ОЗДОРОВИТЕЛЬНЫЙ ЦЕНТР</span>-->
            <!--</td>-->
            <!--</tr>-->
            <!--<tr>-->
            <!--<td>-->
            <!--<span class="big">Иркутскэнерго</span>-->
            <!--</td>-->
            <!--<td>-->
            <!--<span class="big">БТИ</span>-->
            <!--</td>-->
            <!--</tr>-->
            <!--</table>-->
        </div>
...
<div class="sertificetes wow fadeIn">
    <div class="container">
        <div class="padleft-200">
            <h2>Сертификаты</h2>
            <div class="sert-block">
                <div class="sert-slider" id="carousel">
                    <img src="{{ asset('img/sert-1.png') }}" data-num="1">
                    <img src="{{ asset('img/sert-2.png') }}" data-num="2">
                    <img src="{{ asset('img/sert-3.png') }}" data-num="3">
                    <img src="{{ asset('img/sert-4.png') }}" data-num="4">
                    <img src="{{ asset('img/sert-5.png') }}" data-num="5">
                    <img src="{{ asset('img/sert-6.png') }}" data-num="5">
                    <img src="{{ asset('img/sert-7.png') }}" data-num="5">
                    <img src="{{ asset('img/sert-8.png') }}" data-num="5">
                    <img src="{{ asset('img/sert-9.png') }}" data-num="5">
                </div>
                <div class="sert-slider-nav-850"></div>
                <div class="carousel-nav flex-box flex-center">
                    <div class="carousel-arrows" id="carousel_prev">
                        <a href="#"></a>
                    </div>
                    <div class="carousel-num">
                        <span id="carousel_current">01</span>
                        /
                        <span id="carousel_amount">01</span>
                    </div>
                    <div class="carousel-arrows" id="carousel_next">
                        <a href="#"></a>
                    </div>
                </div>
            </div>
