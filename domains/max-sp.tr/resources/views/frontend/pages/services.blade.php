...
@section('content')
    <div class="main main_inner" style="background-image: url({{ asset('img/service-bg.jpg') }});">
        <div class="container">
            <h1>Наши услуги</h1>
            <p class="sub-title">Мы с уверенностью сделаем теплый пол в любом помещении, по&nbsp;любому основанию.</p>
        </div>
    </div>
    <div class="hydrofloor wow fadeIn">
        <div class="hydrofloor-bg">
            <div class="container">
                <div class="padleft-160">
                    <h2>Гидравлические<br>
                        <span class="yellow">теплые полы</span></h2>
                    <p>Система гидравлического тёплого пола представляет собой вмонтированные в пол трубы, в них
                        находится
                        тёплая вода. Такая система отопления отличается тем, что прогревание воздуха происходит по всей
                        площади
                        пола. Прогретый воздух оказывается внизу, а когда начинает подниматься, остывает. При этом в
                        помещении
                        тепло и не душно. Система гидравлического тёплого пола безопасна и экономична, создаёт более
                        здоровую
                        атмосферу воздуха, чем при других видах отопления.</p>
                    <div class="hydrofloor-block flex-box">
                        <div class="hydrofloor-block-inner">
                            <div class="hydrofloor-item">Равномерный прогрев<br> помещения</div>
                            <div class="hydrofloor-item">Экономия<br> электроэнергии до 30%</div>
                            <div class="hydrofloor-item">Срок службы<br> более 50 лет</div>
                            <div class="hydrofloor-item">Легкое управление<br> температурой</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="dop wow fadeIn">
        <div class="container">
            <div class="padleft-200">
                <h2>Дополнительные<br> услуги</h2>
                <div class="dop-block flex-box space-between">
                    <div class="left">
                        <p>Так же мы оказываем услуги по монтажу водоснабжения и&nbsp;водоотведения, устройство систем
                            вентиляции
                            и кондиционирования, производим ремонт труб.</p>
                    </div>
                    <div class="right">
                        <div class="dop-item">
                            <div class="big">Водоснабжение</div>
                            <div class="small">Монтаж системы водоснабжения и водопровода</div>
                        </div>
                        <div class="dop-item">
                            <div class="big">Водоотведение</div>
                            <div class="small">Монтаж систем канализации и водоотведения</div>
                        </div>
                        <div class="dop-item">
                            <div class="big">Внешние сети, вентиляция, кондиционирование</div>
                            <div class="small">Устройство системы приточно-вытяжной вентиляции и кондиционирования
                                воздуха
                            </div>
                        </div>
                        <div class="dop-item">
                            <div class="big">Ремонт труб</div>
                            <div class="small">Замена и ремонт труб</div>
                        </div>
                    </div>
                </div>
            </div>
